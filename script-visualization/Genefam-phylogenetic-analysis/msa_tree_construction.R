...
genefam_phylogenetic_analysis <- function(wkdir_name, msa_method, pairwisedist_method, phylotree_layout, bootstrap_rep){
  ...
  seq_cluster_dist = dist.dna(seq_cluster_dnabin, model=pairwisedist_method, gamma=T, as.matrix=T)
  ...
  #msaPrettyPrint(seq_cluster_msa)
  # Heatmap =====
  ...
  ggsave("phylotree_nj.png", plot=plt_njtree, dpi = 400)
